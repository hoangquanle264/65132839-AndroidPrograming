...
public class ChiTietBaiAdapter extends RecyclerView.Adapter<ChiTietBaiAdapter.ItemBaiThuocHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemBaiThuocHolder holder, int position) {
        ...
        ChiTietBaiActivity landScapeHienThi = lstData.get(position);
        // Trích thông tin
        String caption = landScapeHienThi.getBaiThuocCation();
        String tenFileAnh = landScapeHienThi.getBaiThuocImageFileName();
        String thoiGian = landScapeHienThi.getThoiGian();
