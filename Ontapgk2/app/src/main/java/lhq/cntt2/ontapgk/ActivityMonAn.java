...
public class ActivityMonAn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dsMonAn.add(new ChiTietMonActivity("Cơm sườn tấm", 25000, "Đặc sản Nha Trang"));
        dsMonAn.add(new ChiTietMonActivity("Cơm gà", 30000, "Đặc sản Nha Trang"));
        dsMonAn.add(new ChiTietMonActivity("Cơm sườn bì", 27000, "Đặc sản Nha Trang"));
        //
