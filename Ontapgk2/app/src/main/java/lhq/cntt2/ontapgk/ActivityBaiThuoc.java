...
public class ActivityBaiThuoc extends AppCompatActivity {
    ...
    ArrayList<ChiTietBaiActivity> getDataForRecyclerView() {
        ...
        ChiTietBaiActivity landScape1 = new ChiTietBaiActivity("giunsang", " chữa giun sáng", "4/10/2021");
        dsDuLieu.add(landScape1);
        dsDuLieu.add(new ChiTietBaiActivity("thuocho", " Giảm ho","4/10/2021"));
        dsDuLieu.add(new ChiTietBaiActivity("thuoctranhthai", " Tránh có chữa","4/10/2021"));
        return dsDuLieu;
    }
